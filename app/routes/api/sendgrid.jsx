...
sendgrid.setApiKey(
  "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"
);

async function sendEmail(data) {
  const { fname, phone, email, description } = data._fields;
  const msg = {
    to: "julian.medve.superdev@gmail.com", // Change to your recipient
    from: "takus.superdev@gmail.com", // Change to your verified sender
    subject: "Hello Sara Sato",
    html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">
              ...
              <h3>You've got a new mail from ${fname}, their email is: ✉️${email},their phone is: ${phone} </h3>
